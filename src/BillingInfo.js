    ...
    return <div style = {main}>
        <Step.Group items={steps} />
            ...
            <form className='billing' onSubmit={handleSubmit} style={formStyle}>
                ...
                <h1 style={{padding: 0}}>Billing infomation</h1>
                <div style={flexStyle}>
                <div style={{width:'45%'}}>
                <p >Name</p>
                ...
                <p>Note</p>
                <textarea style={{height:'200px'}} name='note' onChange={handleChange} placeholder='Note'></textarea>
            <div> 
                <div style={{fontSize:'20px', padding:'10% 0 0 30%'}}>Total: {props.location.state.total} €</div>
            <Button style={{width:"90%" , marginTop: '2em'}}>Go to pay</Button>
            </div>
        </form>
  </div>
}
